...
import { getRoleWorker, findFreeSlot, countActiveSlots, reconcileSlots } from "../../projects/index.js";
...
import { getActiveLabel, getNotifyLabel, NOTIFY_LABEL_COLOR, NOTIFY_LABEL_PREFIX, ExecutionMode, getCurrentStateLabel } from "../../workflow/index.js";
import { loadConfig } from "../../config/index.js";
import { loadInstanceName } from "../../instance.js";

export function createWorkStartTool(ctx: PluginContext) {
  return (toolCtx: ToolContext) => ({
    ...
    async execute(_id: string, params: Record<string, unknown>) {
      ...
      const dr = await dispatchTask({
        workspaceDir, agentId: toolCtx.agentId, project, issueId: issue.iid,
