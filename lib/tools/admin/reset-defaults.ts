...
import { readProjects, updateSlot } from "../../projects/index.js";
import {
  AGENTS_MD_TEMPLATE,
...
import { hashContent, writePromptHashes, clearStalePrompts } from "../../setup/prompt-hashes.js";

export function createResetDefaultsTool(ctx: PluginContext) {
